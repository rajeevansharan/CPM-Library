          ...
          <View className="p-6">
            ...
            >
              <MaterialCommunityIcons
                ...
                color="#0B2556"
              />
              <Text className="text-[#0B2556] font-black ml-2 uppercase tracking-tight text-sm">
                Generate PDF
              </Text>
            </TouchableOpacity>
              ...
              <View className="flex-row w-full">
                ...
                >
                  <MaterialCommunityIcons
                    ...
                    color="#0B2556"
                  />
                  <Text className="text-[#0B2556] font-bold text-[11px] ml-1.5">
                    WhatsApp
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
...
const OptionRow = ({
  ...
  >
    <View className="flex-row items-center">
      ...
      <Text className="text-[#0B2556] font-bold text-sm tracking-tight">
        {label}
      </Text>
    </View>
    <View
